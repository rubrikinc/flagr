...
// FlagJSONEq is an autogenerated method
// nolint: dupl
func (qs FlagSnapshotQuerySet) FlagJSONEq(flagJSON string) FlagSnapshotQuerySet {
	return qs.w(qs.db.Where("flag_json = ?", flagJSON))
}

// FlagJSONIn is an autogenerated method
// nolint: dupl
func (qs FlagSnapshotQuerySet) FlagJSONIn(flagJSON ...string) FlagSnapshotQuerySet {
	if len(flagJSON) == 0 {
		qs.db.AddError(errors.New("must at least pass one flagJSON in FlagJSONIn"))
		return qs.w(qs.db)
	}
	return qs.w(qs.db.Where("flag_json IN (?)", flagJSON))
}

// FlagJSONNe is an autogenerated method
// nolint: dupl
func (qs FlagSnapshotQuerySet) FlagJSONNe(flagJSON string) FlagSnapshotQuerySet {
	return qs.w(qs.db.Where("flag_json != ?", flagJSON))
}

// FlagJSONNotIn is an autogenerated method
// nolint: dupl
func (qs FlagSnapshotQuerySet) FlagJSONNotIn(flagJSON ...string) FlagSnapshotQuerySet {
	if len(flagJSON) == 0 {
		qs.db.AddError(errors.New("must at least pass one flagJSON in FlagJSONNotIn"))
		return qs.w(qs.db)
	}
	return qs.w(qs.db.Where("flag_json NOT IN (?)", flagJSON))
}
...
// SetFlagJSON is an autogenerated method
// nolint: dupl
func (u FlagSnapshotUpdater) SetFlagJSON(flagJSON string) FlagSnapshotUpdater {
	u.fields[string(FlagSnapshotDBSchema.FlagJSON)] = flagJSON
	return u
}
...
var FlagSnapshotDBSchema = struct {
	...
	FlagJSON  FlagSnapshotDBSchemaField
}{
	...
	FlagJSON:  FlagSnapshotDBSchemaField("flag_json"),
}
